			...
			<div id="bottom">
				<form action="${pageContext.request.contextPath}/admin/regist.action" method="post">
					<table border="0px" id="table">
						<tr>
							<td class="td1">用户名：</td>
							<td><input type="text" placeholder="Username" class="td2" name="rname"></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							<td class="td1">密码：</td>
							<td><input type="password" placeholder="Password" class="td2" name="rpwd"></td>
						</tr>
						<tr>
							<td class="td1">确认密码：</td>
							<td><input type="password" placeholder="Password" class="td2" name="mpwd"></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							...
							<td><input type="submit" value="注册" class="td3">
								<input type="reset" value="重置" class="td3">
							</td>
						</tr>
					</table>
				</form>
